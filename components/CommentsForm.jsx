...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="mt-8">
        <button type="button" onClick={handlePostSubmission} className="transition duration-500 ease transform hover:-translate-y-1 inline-block bg-gradient-to-r from-green-400 to-blue-500 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer hover:from-pink-500 hover:to-yellow-500">Post Comment</button>
